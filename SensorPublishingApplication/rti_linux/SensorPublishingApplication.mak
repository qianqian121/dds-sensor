...
SensorPublisher.o : SensorPublisher.cpp SensorPublisher.h    
	@echo Compiling SensorPublisher.cpp
	$(CREATE_OBJ_DIR)
	@$(CC) $(ConfigurationCPPCompileSwitches)  -o SensorPublisher.o SensorPublisher.cpp
...
####################################################################################
$(TARGET_NAME)$(EXE_EXT):  $(OBJS) $(ADDITIONAL_OBJS) $(TARGET_MAIN)$(OBJ_EXT) SensorPublishingApplication.mak ../../SensorTopicStructLib/rti_linux/SensorTopicStructLib.a
