...
TARGET_NAME=SensorPublishingApplication

all : $(TARGET_NAME)$(EXE_EXT) SensorPublishingApplication.mak

TARGET_MAIN=MainSensorPublishingApplication
...
SensorPublisher.obj : SensorPublisher.cpp SensorPublisher.h    
	$(CREATE_OBJ_DIR)
	$(CPP) $(ConfigurationCPPCompileSwitches)  /Fo"SensorPublisher.obj" "SensorPublisher.cpp" 
...
###############################################################################
$(TARGET_NAME)$(EXE_EXT):  $(OBJS) $(ADDITIONAL_OBJS) $(TARGET_MAIN)$(OBJ_EXT) SensorPublishingApplication.mak ..\..\SensorTopicStructLib\rti_windows\SensorTopicStructLib.lib
...
$(TARGET_NAME)$(LIB_EXT) :  $(OBJS) $(ADDITIONAL_OBJS) SensorPublishingApplication.mak
	@echo Building library $@
	$(LIB_CMD) $(LIB_FLAGS) /out:$(TARGET_NAME)$(LIB_EXT) $(OBJS) $(ADDITIONAL_OBJS) $(LIBS)

clean:
	@echo Cleanup
	if exist SensorPublisher.obj erase SensorPublisher.obj
