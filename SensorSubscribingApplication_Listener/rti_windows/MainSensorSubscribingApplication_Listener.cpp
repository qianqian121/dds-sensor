...
//!	Generated Date	: Mon, 7, Aug 2017  
	File Path	: SensorSubscribingApplication_Listener\rti_windows\MainSensorSubscribingApplication_Listener.cpp
*********************************************************************/
    ...
    if(OXF::initialize())
        {
            ...
            //#[ configuration SensorSubscribingApplication_Listener::rti_windows 
            //#]
            OXF::start();
