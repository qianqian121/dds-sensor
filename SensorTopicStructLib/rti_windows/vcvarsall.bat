...
echo     %~nx0 [arch] 
echo   or
echo     %~nx0 [arch] [version]
echo   or
echo     %~nx0 [arch] [platform_type] [version]
echo where : 
echo     [arch]: x86 ^| amd64 ^| x86_amd64 ^| x86_arm ^| x86_arm64 ^| amd64_x86 ^| amd64_arm ^| amd64_arm64
echo     [platform_type]: {empty} ^| store ^| uwp 
echo     [version] : full Windows 10 SDK number (e.g. 10.0.10240.0) or "8.1" to use the Windows 8.1 SDK.   
echo:
...
echo     %~nx0 x86_arm onecore 10.0.10240.0
echo     %~nx0 x64 8.1
