...
OBJS= \
  DDSSensorTopicStructLib.obj \
  DDSSensorTopicStructLibSupport.obj \
  DDSSensorTopicStructLibPlugin.obj
...
DDSSensorTopicStructLib.obj : DDSSensorTopicStructLib.cxx DDSSensorTopicStructLib.h
	@echo Compiling DDSSensorTopicStructLib.cxx
	$(CPP) $(ConfigurationCPPCompileSwitches)  /Fo"DDSSensorTopicStructLib.obj" "DDSSensorTopicStructLib.cxx"
...
DDSSensorTopicStructLibSupport.obj : DDSSensorTopicStructLibSupport.cxx DDSSensorTopicStructLib.h
	@echo Compiling DDSSensorTopicStructLibSupport.cxx
	$(CPP) $(ConfigurationCPPCompileSwitches)  /Fo"DDSSensorTopicStructLibSupport.obj" "DDSSensorTopicStructLibSupport.cxx"
...
DDSSensorTopicStructLibPlugin.obj : DDSSensorTopicStructLibPlugin.cxx DDSSensorTopicStructLibPlugin.h
	@echo Compiling DDSSensorTopicStructLibPlugin.cxx
	$(CPP) $(ConfigurationCPPCompileSwitches)  /Fo"DDSSensorTopicStructLibPlugin.obj" "DDSSensorTopicStructLibPlugin.cxx"
...
###############################################################################
$(TARGET_NAME)$(EXE_EXT): $(OBJS) $(ADDITIONAL_OBJS) $(TARGET_MAIN)$(OBJ_EXT) SensorTopicStructLib.mak 
...
$(TARGET_NAME)$(LIB_EXT) : $(OBJS) $(ADDITIONAL_OBJS) SensorTopicStructLib.mak
...
clean:
	...
	$(CLEAN_OBJ_DIR)
	if exist DDSSensorTopicStructLib*.cxx erase DDSSensorTopicStructLib*.cxx
	if exist DDSSensorTopicStructLib*.h erase DDSSensorTopicStructLib*.h
